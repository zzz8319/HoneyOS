...
// bee values sum = 185 → 18,500 estimated bees
const F1: FrameRecord = { bee: 35, brood: 22, honey: 20 }
const F2: FrameRecord = { bee: 32, brood: 18, honey: 28 }
const F3: FrameRecord = { bee: 26, brood: 20, honey: 30 }
const F4: FrameRecord = { bee: 22, brood: 15, honey: 35 }
const F6: FrameRecord = { bee: 18, brood: 10, honey: 42 }
const F7: FrameRecord = { bee: 12, brood: 8,  honey: 45 }
...
const STAGES_AUG28: ViewerStage[] = [
  ...
  },
  {
    ...
    label: '1段目',
    frameCount: 8,
    frames: [F1, F2, F3, F4, null, F6, F7, null],
